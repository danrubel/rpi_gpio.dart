...
typedef GpiodChipFindLinesFfi = ffi.Int32 Function(ffi.Pointer<GpiodChip>, ffi.Pointer<ffi.Pointer<ffi.Utf8>>, ffi.Pointer<GpiodLineBulk>);
typedef GpiodChipGetAllLinesFfi = ffi.Int32 Function(ffi.Pointer<GpiodChip>, ffi.Pointer<GpiodLineBulk>);
typedef GpiodChipGetLineFfi = ffi.Pointer<GpiodLine> Function(ffi.Pointer<GpiodChip>, ffi.Int32);
typedef GpiodChipGetLinesFfi = ffi.Int32 Function(ffi.Pointer<GpiodChip>, ffi.Pointer, ffi.Int32, ffi.Pointer<GpiodLineBulk>);
...
typedef GpiodChipNumLinesFfi = ffi.Int32 Function(ffi.Pointer<GpiodChip>);
...
typedef GpiodChipOpenByNumberFfi = ffi.Pointer<GpiodChip> Function(ffi.Int32);
typedef GpiodChipOpenLookupFfi = ffi.Pointer<GpiodChip> Function(ffi.Pointer<ffi.Utf8>);
// typedef GpiodCtxlessEventMonitorFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, ffi.Pointer<Timespec>, GpiodCtxlessEventPollCb, GpiodCtxlessEventHandleCb, ffi.Pointer<ffi.Void>);
// typedef GpiodCtxlessEventMonitorExtFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, ffi.Pointer<Timespec>, GpiodCtxlessEventPollCb, GpiodCtxlessEventHandleCb, ffi.Pointer<ffi.Void>, ffi.Int32);
// typedef GpiodCtxlessEventMonitorMultipleFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Pointer, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, ffi.Pointer<Timespec>, GpiodCtxlessEventPollCb, GpiodCtxlessEventHandleCb, ffi.Pointer<ffi.Void>);
// typedef GpiodCtxlessEventMonitorMultipleExtFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Pointer, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, ffi.Pointer<Timespec>, GpiodCtxlessEventPollCb, GpiodCtxlessEventHandleCb, ffi.Pointer<ffi.Void>, ffi.Int32);
typedef GpiodCtxlessFindLineFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Pointer);
typedef GpiodCtxlessGetValueFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>);
typedef GpiodCtxlessGetValueExtFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodCtxlessGetValueMultipleFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Pointer, ffi.Pointer, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>);
typedef GpiodCtxlessGetValueMultipleExtFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Pointer, ffi.Pointer, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, ffi.Int32);
// typedef GpiodCtxlessSetValueFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, GpiodCtxlessSetValueCb, ffi.Pointer<ffi.Void>);
// typedef GpiodCtxlessSetValueExtFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, GpiodCtxlessSetValueCb, ffi.Pointer<ffi.Void>, ffi.Int32);
// typedef GpiodCtxlessSetValueMultipleFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Pointer, ffi.Pointer, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, GpiodCtxlessSetValueCb, ffi.Pointer<ffi.Void>);
// typedef GpiodCtxlessSetValueMultipleExtFfi = ffi.Int32 Function(ffi.Pointer<ffi.Utf8>, ffi.Pointer, ffi.Pointer, ffi.Int32, ffi.Bool, ffi.Pointer<ffi.Utf8>, GpiodCtxlessSetValueCb, ffi.Pointer<ffi.Void>, ffi.Int32);
typedef GpiodLineActiveStateFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
typedef GpiodLineBiasFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
...
typedef GpiodLineDirectionFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
typedef GpiodLineEventGetFdFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
typedef GpiodLineEventReadFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<GpiodLineEvent>);
typedef GpiodLineEventReadFdFfi = ffi.Int32 Function(ffi.Int32, ffi.Pointer<GpiodLineEvent>);
typedef GpiodLineEventReadFdMultipleFfi = ffi.Int32 Function(ffi.Int32, ffi.Pointer<GpiodLineEvent>, ffi.Int32);
typedef GpiodLineEventReadMultipleFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<GpiodLineEvent>, ffi.Int32);
typedef GpiodLineEventWaitFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<Timespec>);
// typedef GpiodLineEventWaitBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<Timespec>, ffi.Pointer<GpiodLineBulk>);
typedef GpiodLineFindFfi = ffi.Pointer<GpiodLine> Function(ffi.Pointer<ffi.Utf8>);
typedef GpiodLineGetFfi = ffi.Pointer<GpiodLine> Function(ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineGetChipFfi = ffi.Pointer<GpiodChip> Function(ffi.Pointer<GpiodLine>);
typedef GpiodLineGetValueFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
typedef GpiodLineGetValueBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer);
...
typedef GpiodLineOffsetFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
...
typedef GpiodLineRequestFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<GpiodLineRequestConfig>, ffi.Int32);
typedef GpiodLineRequestBothEdgesEventsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestBothEdgesEventsFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<GpiodLineRequestConfig>, ffi.Pointer);
typedef GpiodLineRequestBulkBothEdgesEventsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestBulkBothEdgesEventsFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestBulkFallingEdgeEventsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestBulkFallingEdgeEventsFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestBulkInputFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestBulkInputFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestBulkOutputFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>, ffi.Pointer);
typedef GpiodLineRequestBulkOutputFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Pointer);
typedef GpiodLineRequestBulkRisingEdgeEventsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestBulkRisingEdgeEventsFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestFallingEdgeEventsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestFallingEdgeEventsFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestInputFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestInputFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestOutputFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineRequestOutputFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>, ffi.Int32, ffi.Int32);
typedef GpiodLineRequestRisingEdgeEventsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>);
typedef GpiodLineRequestRisingEdgeEventsFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Pointer<ffi.Utf8>, ffi.Int32);
typedef GpiodLineSetConfigFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Int32, ffi.Int32, ffi.Int32);
typedef GpiodLineSetConfigBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Int32, ffi.Int32, ffi.Pointer);
typedef GpiodLineSetDirectionInputFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
typedef GpiodLineSetDirectionInputBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>);
typedef GpiodLineSetDirectionOutputFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Int32);
typedef GpiodLineSetDirectionOutputBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer);
typedef GpiodLineSetFlagsFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Int32);
typedef GpiodLineSetFlagsBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Int32);
typedef GpiodLineSetValueFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>, ffi.Int32);
typedef GpiodLineSetValueBulkFfi = ffi.Int32 Function(ffi.Pointer<GpiodLineBulk>, ffi.Pointer);
typedef GpiodLineUpdateFfi = ffi.Int32 Function(ffi.Pointer<GpiodLine>);
